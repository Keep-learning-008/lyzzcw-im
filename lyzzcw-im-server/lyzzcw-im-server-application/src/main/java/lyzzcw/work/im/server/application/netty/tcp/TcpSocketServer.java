package lyzzcw.work.im.server.application.netty.tcp;
...
import lyzzcw.work.im.server.application.netty.IMNettyServer;
import lyzzcw.work.im.server.application.netty.handler.IMChannelHandler;
import lyzzcw.work.im.server.application.netty.tcp.codec.TcpSocketMessageProtocolDecoder;
import lyzzcw.work.im.server.application.netty.tcp.codec.TcpSocketMessageProtocolEncoder;
 ...
 */
@Component
@ConditionalOnProperty(prefix = "tcpsocket", value = "enable",
