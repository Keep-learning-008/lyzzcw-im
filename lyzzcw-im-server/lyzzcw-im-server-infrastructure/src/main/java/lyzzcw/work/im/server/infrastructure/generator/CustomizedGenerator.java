package lyzzcw.work.im.server.infrastructure.generator;
...
public class CustomizedGenerator implements CommentGenerator {
    ...
    public static void main(String[] args) {
        ...
        File configFile = new File(CustomizedGenerator.class.getClassLoader().getResource("generatorConfig.xml").getFile());
